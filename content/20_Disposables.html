...
<head>
    ...
    <title>Intro to Rx - Appendix C Disposables</title>
    <link rel="stylesheet" href="Kindle.css" type="text/css" />
</head>
<body>
    <a name="Disposables"></a>
    <h1>Disposables</h1>
    <p>
        Rx leverages the existing <em>IDisposable</em> interface for subscription management.
        This is an incredibly useful design decision, as users can work with a familiar
        type and reuse existing language features. Rx further extends its usage of the <em>IDisposable</em>
        type by providing several public implementations of the interface. These can be
        found in the <em>System.Reactive.Disposables</em> namespace. Here, we will briefly
