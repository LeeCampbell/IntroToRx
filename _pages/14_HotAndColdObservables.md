---
layout: page
permalink: /14_HotAndColdObservables.html
...
This code illustrates that the `Take(3)` expression will restrict what the consumer receives but `GetProducts()` method will still publish *all* of the values.
