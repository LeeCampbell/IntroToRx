...
To avoid having to oscillate between push and pull, you can use one of
...
The *ToEvent* method returns an *IEventSource\<T\>*, which will have a
...
These look quite easy to work with. So if we create an *EventArgs* type
